...
fprintf('================================================================\n');
fprintf('Autor: Pavel Skabeltsyn\n');
...
fprintf(fid, ' * @author Pavel Skabeltsyn\n');
fprintf(fid, ' * @date %s\n', datestr(now, 'yyyy'));
...
fprintf(fid, ' * \n');
fprintf(fid, ' * Implementacja własna - autor Skabeltsyn.\n');
fprintf(fid, ' */\n\n');
...
fprintf(fid, ' * Implementacja własna - autor Pavel Skabeltsyn.\n');
fprintf(fid, ' */\n');
